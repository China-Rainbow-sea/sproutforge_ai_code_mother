...
import com.rainbowsea.sproutforgeaicodebackend.ai.AiCodeGenTypeRoutingServiceFactory;
...
import com.rainbowsea.sproutforgeaicodebackend.core.handler.StreamHandlerExecutor;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 5. 调用 AI 前，先保存用户消息到数据库当中，通过校验后，添加用户消息到对话历史
